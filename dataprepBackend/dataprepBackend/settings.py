"""
Django settings for dataprepBackend project.
...
SECRET_KEY = 'django-insecure-j2sor$nz0di3aob(m56xpk%@s7l8f(6bg%8x+)nq69@)n$!)9='
...
WSGI_APPLICATION = 'dataprepBackend.wsgi.application'
